...
export default function LandingPage() {
	...
	return (
		<div className="h-screen w-full flex items-center justify-center">
			...
			<div className="z-10">
				<div className='text-7xl'>KEEP YOUR LIFE UNDER CONTROL</div>
				<div className='text-2xl'>Make every day more productive with our intuitive to-do list app. Stay organized, set priorities, and achieve your goals. Sign up now and start getting things done.</div>
			</div>
		</div>
	)
}